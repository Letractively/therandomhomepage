...
//--- Slideshow options
var slideShowWidth = 540;	// -1 size slideshow window based on each image
var slideShowHeight = 360;	// -1 size slideshow window based on each image
var SlideShowStartImage = "lightbox/start.gif";	// Slideshow toggle button
...
var loopInterval = 4500;	// image swap interval

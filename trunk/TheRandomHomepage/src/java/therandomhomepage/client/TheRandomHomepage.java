...
public class TheRandomHomepage implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    private void buildBody() {
        ...
        randomWikipediaGadget.setHeight("600px");
        grid.setWidget(0, 1, randomWikipediaGadget);
